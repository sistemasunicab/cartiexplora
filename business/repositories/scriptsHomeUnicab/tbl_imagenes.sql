...
(14, 'assets/img/campus.jpg', '', '<b>Conoce</b><br> Nuestro Campus', '', '', 'campus unicab'),
...
(15, 'assets/img/g2784@2x.png', 'En UNICAB Corporación Educativa, nos dedicamos a ofrecer una educación de calidad, humanista, innovadora y pertinente. <b>Nuestro modelo educativo, centrado en el estudiante</b>, se basa en la investigación y el desarrollo de aprendizajes dinámicos e incluyentes, alineados con las demandas de la sociedad del conocimiento. <br><br> Promovemos el pensamiento crítico, la creatividad y el aprendizaje continuo, todo ello inspirado en principios y valores que empoderan a nuestros estudiantes como líderes responsables y ciudadanos globales comprometidos con su entorno. ', '<b>Nuestra</b> Misión', '', '', 'Nuestra Misión'),
...
(16, 'assets/img/search.png', 'icon-search', '', '', '', 'buscar'),
(16, 'assets/img/CONTACTOS.png', 'image-contact', '', '', '', 'image'),
(16, 'assets/img/name1.png', 'table-icon', '', '', '', 'name'),
(16, 'assets/img/name2.png', 'table-icon', '', '', '', 'department'),
