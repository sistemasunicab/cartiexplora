...
(11, 'assets/img/organigrama.jpg', 'organigrama', 'organigrama', '', '', 'organigrama'),
(12, 'assets/img/_DSC0141.jpg', '', '', '', '', 'unicab'),
(12, 'assets/img/_DSC0152.jpg', '', '', '', '', 'unicab'),
(12, 'assets/img/sotarira.jpg', '', '', '', '', 'unicab'),
(13, 'assets/img/Grupo 1@2x.png', 'Desde hace 17 años el Colegio se creó para servir a estudiantes con necesidades socioeconómicas especiales que con ignición profunda desean desarrollar sus habilidades personales especiales y estudiar su primaria y bachillerato (grado 1 a grado 11) como: deportistas en vía del alto rendimiento, artistas del ballet y la danza, el teatro, la pintura, investigadores de ciencia y tecnología, estudiantes cuyas familias viajan por Colombia y el mundo, estudiantes con situaciones de salud especiales entre otros.', 'Educación Regular(grado 1 a grado 11)', '', '', 'Educación regular'),
(13, 'assets/img/Grupo 2@2x.png', 'El Colegio presta también el servicio de manera virtual a personas mayores de 18 años que no han podido terminar su bachillerato, a través de la modalidad de ciclos propedéuticos (2 años en 1) de manera virtual.', 'Educación por ciclos para adultos', '', '', 'Educación por ciclos'),
(13, 'assets/img/Grupo 3@2x.png', 'Se realiza a través de una plataforma tecnológica MOODLE versión 3.11.18 gamificada, y Maestros Mediadores del Conocimiento que atienden a los estudiantes que se encuentran desde cualquier lugar del mundo a través de las modernas Tecnologías de la Información y Comunicación TIC, permitiéndoles incorporar en sus aprendizajes autonomía, desarrollo de habilidades de pensamiento, desarrollo de su curiosidad, creatividad y manejo de nuevas herramientas tecnológicas que los prepara para el actual y futuro mundo del conocimiento.', 'El proceso Enseñanza- Aprendizaje', '', '', 'El proceso Enseñanza'),
(13, 'assets/img/Grupo 4@2x.png', 'Reconocido por la Secretaría de Educación de Sogamoso (Entidad certificada en Educación), a través de la cual hasta 2023 se han graduado 655 estudiantes bachilleres que han continuado con sus estudios superiores en el país y en países como EEUU, Japón, Italia, Argentina, y Chile entre otros.', 'Contamos con un Acto Administrativo vigente', '', '', 'Administrativo vigente'),
(14, 'assets/img/campus.jpg', '', '', '', '', 'campus unicab'),
(15, 'assets/img/people_16003670@2x.png', 'Somos un grupo de soñadores que pensamos que la educación tiene que transformarse como un derecho-servicio en beneficio de la gente y por eso creamos una Corporación sin ánimo de lucro hace 23 y desde entonces nos hemos dedicada a ofrecer servicios integrales en proyectos educativos dinámicos e incluyentes. \n Nuestra labor está fundamentada en las necesidades de las comunidades, con un enfoque en las ciencias, la investigación y las tecnologías de la información y comunicación. Nos comprometemos con modelos estratégicos de gestión de calidad, brindando asesorías y consultorías que contribuyen al fortalecimiento y posicionamiento del sector productivo, en sintonía con nuestro propósito social.', '<b>¿Quiénes</b> Somos?', '', '', '¿Quiénes Somos?'),
(15, 'assets/img/g2784@2x.png', 'En UNICAB Corporación Educativa, nos dedicamos a ofrecer una educación de calidad, humanista, innovadora y pertinente. Nuestro modelo educativo, centrado en el estudiante, se basa en la investigación y el desarrollo de aprendizajes dinámicos e incluyentes, alineados con las demandas de la sociedad del conocimiento. \n Promovemos el pensamiento crítico, la creatividad y el aprendizaje continuo, todo ello inspirado en principios y valores que empoderan a nuestros estudiantes como líderes responsables y ciudadanos globales comprometidos con su entorno. ', '<b>Nuestra Misión</b>', '', '', 'Nuestra Misión'),
(15, 'assets/img/vision_2967345@2x.png', 'Para el año 2027, seremos referentes en educación innovadora y transformadora, destacándonos por nuestra investigación en TIC y nuestro compromiso con el desarrollo de habilidades y potencialidades de nuestros estudiantes. Aspiramos a formar líderes que, desde la curiosidad y la colaboración, contribuyan a transformar sus comunidades de manera inclusiva y participativa en una sociedad global en constante evolución.', '<b>Nuestra</b> Visión', '', '', 'Nuestra visión');
