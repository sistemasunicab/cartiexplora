...
('Rectoría', 'raiz', '1', '', '', '',''),
('Consejo de Padres', 'raiz', '1', '', '', '',''),
('Consejo Estudiantil', 'raiz', '1', '', '', '', ''),
...
('Sistema de Admisiones y Matrículas', 'uno', '8', '', 'business/org/pages/sistemaAdmisionesMatriculas.php', 'sistemaAdmisionesMatriculas.php',''),
...
('Costos Educativos y Formas de Pago', 'uno', '8', '', 'business/org/pages/costosEducativosFormasPago.php', 'costosEducativosFormasPago.php',''),
('Manual de Convivencia', 'uno', '8', '', 'business/org/pages/manualConvivencia.php', 'manualConvivencia.php',''),
('Educación por Ciclos Propedéuticos (Mayores de 18 años)', 'uno', '8', '', 'business/org/pages/educacionCiclosPropedeuticos.php', 'educacionCiclosPropedeuticos.php',''),
('Sistema de admisiones', 'uno', '8', '', 'business/org/pages/sistemaAdmisiones.php', 'sistemaAdmisiones.php',''),
('Solicitud de certificaciones', 'uno', '8', '', 'business/org/pages/solicitudCertificaciones.php', 'solicitudCertificaciones.php',''),
('Costos y formas de pago', 'uno', '8', '', 'business/org/pages/costosFormasPago.php', 'costosFormasPago.php',''),
