            ...
            <div class="first-footer col-11 m-auto d-flex flex-column flex-md-row tx-white justify-content-end pb-5">
                ...
                <div class="col-12 col-md-5 d-flex flex-column pt-4 mx-auto m-auto">
                    <div class="d-flex flex-column mb-3 mx-auto">
                        <p class="lh-sm font-roboto-thinitalic text-center my-0 mx-auto tx-white opacity-75">Llámanos o
                            escríbenos</p>
                        <h5 class="lh-sm font-roboto-bolditalic text-center my-0 mx-auto tx-white"><?php echo $tel ?></h5>
                        <h5 class="lh-sm font-roboto-bolditalic text-center my-0 mx-auto tx-white"><?php echo $correo ?>
                        </h5>
                    </div>
                    <div id="info" class="d-flex flex-column w-auto mx-auto">
                        <p class="special-paragraph font-roboto-bolditalic text-center my-0 mx-auto">Encuéntranos</p>
                        <?php echo $hmtl_social_media; ?>
                        <p class="font-roboto-light text-center mx-auto mt-4 mb-0 tx-white"><?php echo $direccion ?></p>
                        <p class="font-roboto-light text-center mx-auto my-0 pb-3 tx-white"><?php echo $ubicacion ?></p>
                    </div>
