            ...
            if ($tipo === 'submit') {
                ...
                $html .=
                    '<div class="row justify-content-center align-items-start my-4">' .
                        '<input class="col-md-1 inscripciones-input" onclick="validar_campo(this)" type="' . $tipo . '" id="inscripciones_' . $campo . '" name="' . $campo . '" ' . $obligatorio . ' ' . $soloLectura . ' ' . $deshabilitado . '>' .
                        '<p class="form-text col-md-11">'. $parametros['checkbox_form_inscripciones'] .'</p>' .
                    '</div>';
